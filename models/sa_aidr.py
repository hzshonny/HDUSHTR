...
from models.MSFFAM import MSFFAM
...
class STRAIDR(nn.Layer):
    ...
    def forward(self, x):
        ...
        # x_mask = self.nn(con_x4)
        # x_mask = self.aspp(x_mask)

        #
        x_mask = self.MSFFAM(x_mask)
        con_x4 = self.SE4(con_x4)
        con_x3 = self.SE3(con_x3)
        con_x2 = self.SE2(con_x2)
        con_x1 = self.SE1(con_x1)
